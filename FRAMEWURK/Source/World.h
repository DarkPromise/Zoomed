...
enum TILE_CORRIDOR
{
	TILE_CORRIDOR_FLOOR = 163,
	TILE_CORRIDOR_TOP_WALL = 501,
	TILE_CORRIDOR_BOTTOM_WALL = 499,
	TILE_CORRIDOR_LEFT_WALL = 502,
	TILE_CORRIDOR_RIGHT_WALL = 500,
	TILE_CORRIDOR_TOP_LEFT_CORNER = 506,
	TILE_CORRIDOR_TOP_RIGHT_CORNER = 503,
	TILE_CORRIDOR_BOTTOM_LEFT_CORNER = 505,
	TILE_CORRIDOR_BOTTOM_RIGHT_CORNER = 504,
	TILE_CORRIDOR_INNER_TOP_LEFT_CORNER = 474,
	TILE_CORRIDOR_INNER_TOP_RIGHT_CORNER = 473,
	TILE_CORRIDOR_INNER_BOTTOM_LEFT_CORNER = 471,
	TILE_CORRIDOR_INNER_BOTTOM_RIGHT_CORNER = 472
};
